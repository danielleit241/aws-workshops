...
![3.3.1](/images/Workshop/3-Monitoring&Security/3.3.1.svg)
...
![3.3.2](/images/Workshop/3-Monitoring&Security/3.3.2.svg)
...
![3.3.3](/images/Workshop/3-Monitoring&Security/3.3.3.svg)
...
![3.3.4](/images/Workshop/3-Monitoring&Security/3.3.4.svg)

- Giữ nguyên cấu hình ghi log các **Management events**
- Nhấn **Next** thêm lần nữa

![3.3.5](/images/Workshop/3-Monitoring&Security/3.3.5.svg)

- Nhấn **Create trail**.

![3.3.6](/images/Workshop/3-Monitoring&Security/3.3.6.svg)

- Kiểm tra Trail đã được tạo **Successfully**
- Và **Status** ở trạng thái **Logging**

![3.3.7](/images/Workshop/3-Monitoring&Security/3.3.7.svg)
