...
![Start Redshift Serverless custom setup](/images/manhattan-dataways/redshift-spectrum/Creation/1-Workgroup/1.png)
...
![Workgroup name](/images/manhattan-dataways/redshift-spectrum/Creation/1-Workgroup/1.png)
...
![Set base capacity to 4 RPU](/images/manhattan-dataways/redshift-spectrum/Creation/1-Workgroup/2.png)
...
![Autonomics configuration](/images/manhattan-dataways/redshift-spectrum/Creation/1-Workgroup/3.png)

![Optional max capacity limit](/images/manhattan-dataways/redshift-spectrum/Creation/1-Workgroup/4.png)

![Track setting](/images/manhattan-dataways/redshift-spectrum/Creation/1-Workgroup/5.png)
...
![Network and security settings](/images/manhattan-dataways/redshift-spectrum/Creation/1-Workgroup/6.png)
...
![Namespace name](/images/manhattan-dataways/redshift-spectrum/Creation/2-Namespace/1.png)

- **Database name**: `dev`

![Database name and admin credentials](/images/manhattan-dataways/redshift-spectrum/Creation/2-Namespace/2.png)
...
![Open IAM role association](/images/manhattan-dataways/redshift-spectrum/Creation/2-Namespace/3.png)

Then continue the role association process.

![Choose IAM role to associate](/images/manhattan-dataways/redshift-spectrum/Creation/2-Namespace/4.png)

After the role is attached, make sure it appears as an associated role for the namespace.

![IAM role attached to namespace](/images/manhattan-dataways/redshift-spectrum/Creation/2-Namespace/5.png)
...
![Encryption and security defaults](/images/manhattan-dataways/redshift-spectrum/Creation/2-Namespace/6.png)
...
![Review configuration overview](/images/manhattan-dataways/redshift-spectrum/Creation/3-Review/1.png)
...
![Final review before create](/images/manhattan-dataways/redshift-spectrum/Creation/3-Review/2.png)
